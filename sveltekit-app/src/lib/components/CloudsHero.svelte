...
{#if cloudArtist.slug}
	<div
		class="relative flex justify-center items-center max-w-300 w-[16vw] min-w-14 ml-10 sm:ml-0 sm:absolute sm:right-[16vw] sm:bottom-[20vh] sm:top-auto sm:min-w-16"
	>
		<div
